...
RSpec.describe Embed::File::AuthMessagesComponent, type: :component do
  ...
  context 'when the message is an embargo message' do
    ...
    it 'has svg and message' do
      ...
      expect(page).to have_text('Embargo message')
    end
  end
  ...
  context 'when the message is an location restricted message' do
    ...
    it 'has svg and message' do
      expect(page).to have_css('svg')
      expect(page).to have_css('.authLinkWrapper')
      expect(page).to have_text('Location restricted message')
    end
  end
end
