...
RSpec.describe Embed::Purl::ResourceFile do
  ...
  describe '#label_or_filename' do
    ...
    context 'with pdf transcript' do
      let(:resource_file) { build(:resource_file, :transcript) }

      it { is_expected.to eq 'PDF transcript label' }
    end
  ...
  describe '#caption?' do
    ...
    context 'when it is a caption file' do
      let(:resource_file) { build(:resource_file, role: 'caption') }
  ...
  describe '#transcript?' do
    ...
    context 'when it is a transcription file' do
      let(:resource_file) { build(:resource_file, role: 'transcription') }
