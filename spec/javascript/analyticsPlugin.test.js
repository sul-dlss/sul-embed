...
import analyticsPlugin, {
  deriveManifestType,
  clean,
} from "@/mirador/plugins/analyticsPlugin.js"
...
describe("clean", () => {
  it("removes undefined, null, and empty string values", () => {
    expect(clean({ a: 1, b: undefined, c: null, d: "", e: 0 })).toEqual({
      a: 1,
      e: 0,
    })
  })
...
describe("sendAnalyticsEvent", () => {
  ...
  it("calls window.gtag with cleaned params", () => {
    ...
    const gen = sendAnalyticsEvent({
      payload: {
        eventAction: "mirador/SET_CANVAS",
        manifestId: "http://example.com/manifest",
    ...
    expect(window.gtag).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        manifest_id: "http://example.com/manifest",
      }),
    )
  })
})
