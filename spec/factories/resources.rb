...
FactoryBot.define do
  factory :resource, class: 'Embed::Purl::Resource' do
    ...
    trait :video do
      ...
      files { [build(:resource_file, :video, :world_downloadable), build(:resource_file, :caption, :world_downloadable), build(:resource_file, :transcript, :world_downloadable), build(:resource_file, :image, :world_downloadable, filename: 'video_1.jp2')] }
    end
