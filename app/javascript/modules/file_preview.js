// Class adds behavior to Preview/Close preview for file objects

export default class FilePreview {
  init() {
    const _this = this;
    $('.sul-embed-container').each(function(){
      _this.addPreviewToggleBehavior($(this));
    });
  }
  addPreviewToggleBehavior(container) {
    const _this = this;
    $('[data-sul-embed-file-preview-toggle="true"]', container).each(function(){
      $('a', $(this)).click(function(e){ e.preventDefault(); });
      $(this).click(function(){
        _this.togglePreviewIcon($(this));
        _this.togglePreviewText($(this));
        _this.togglePreviewWindow($(this));
      });
    });
  }
  togglePreviewIcon(preview) {
    const _this = this;
