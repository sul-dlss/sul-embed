...
export default [
  {
    ...
    component: function AllowDragAndDrop({
      targetProps: props,
      TargetComponent,
    }) {
      return (
        <TargetComponent
          {...props}
          classes={{ ...props.classes, workspaceWithControlPanel: "" }}
        />
      )
    },
    mode: "wrap",
  ...
  {
    component: function AllowTopBarClose({
      targetProps: props,
      TargetComponent,
    }) {
      ...
      return (
        <TargetComponent {...props} allowClose={props.windowId !== "main"} />
      )
    },
    mode: "wrap",
    target: "WindowTopBar",
